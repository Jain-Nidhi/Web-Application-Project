		...
		<script>
                $(document).ready(function(){
                        ...
                        $.getJSON("../fetch_activetransactions", function(result){
                            $.each(result, function(i, field){  
                               if(field.buyorsell===false)
                               $("#activeorder").append("<tr><td><h5 style=\"margin-left: 10pt;margin-bottom: 3pt;margin-top: 5pt;color: green\">Order #"+field.tid.substring(0,8)+"/ Date:"+field.tdate.substring(0,12)+"</h5><h5 style=\"margin-left: 10pt;margin-bottom: 3pt;margin-top: 5pt;color: slategrey\">Sale = "+field.quantity+" barrel,Price = $"+(field.rate * field.quantity)+"</h5></td><td valign=\"bottom\"><form id=\"paycancel\" action=\"/Oil_Transaction_System/payment_oil\" ><input type=\"hidden\" name=\"tid\" value=\""+field.tid+"\" /><input name=\"opt1\" class=\"button\" type=\"submit\" value=\"Pay\"  style=\"margin-left: 5pt\"/><input name=\"opt1\" class=\"button\" type=\"submit\" value=\"Cancel\"  style=\"margin-left: 5pt\"/></form></td></tr><tr><td colspan=\"2\"><hr align=\"left\" style=\"margin-left: 10pt;width: 95%\"></td></tr>");
                        ...
                        $.getJSON("../fetch_inactivetransactions", function(result){
                            $.each(result, function(i, field){
                               if(field.buyorsell===false)
                               $("#processedorder").append("<tr><td><h5 style=\"margin-left: 10pt;margin-bottom: 3pt;margin-top: 5pt;color: green\">Order #"+field.tid.substring(0,8)+"/ Date:"+field.tdate.substring(0,12)+"</h5><h5 style=\"margin-left: 10pt;margin-bottom: 3pt;margin-top: 5pt;color: slategrey\">Sale = "+field.quantity+" barrel,Price = $"+(field.rate * field.quantity)+"</h5></td><td valign=\"bottom\"><form id=\"clear\" action=\"/Oil_Transaction_System/payment_oil\" ><input type=\"hidden\" name=\"tid\" value=\""+field.tid+"\"/><input name=\"opt4\" class=\"button\" type=\"submit\" value=\"Clear\"  style=\"margin-left: 10pt\"/></form></td></tr><tr><td colspan=\"2\"><hr align=\"left\" style=\"margin-left: 10pt;width: 95%\"></td></tr>");
                        });
                        });
                });
                 function calculate(){
            ...
            <table align="right" style="margin-right: 80pt">
                <tr>
                    <td style="width: 170pt">
                        <h3 style="color: steelblue;margin-bottom:  30pt">Oil Transactions [Sell]</h3>
                    </td>
                    <td>
            ...
            <div style="width: 100%; height: 442pt; background-color: lavender"> 
                ...
                <div style="width: 85%; height: 440pt; background-color: white;margin-left: 80pt">
                    ...
                    <br><br><br>
                                <ul>
                                   <li>
                                       <a id="buyoil"  href="client_oil.jsp">Purchase Oil</a>
                                    </li>
                                    <li>
                                        <a id="selloil" class="sel" href="selloil.jsp">Sell Oil</a>
                                    </li>
                                <li>
                            ...
                            <td style="width:35%">
                                ...
                                <form id="buyform" action="/Oil_Transaction_System/buysell_oil" >
                                     <table align="left" cellspacing="20" style="margin-top: 30pt">
                                        ...
                                        <tr>
                                            <td valign="top"><input name="opt" class="button" type="submit" value="Sell"/></td>
                                            <td valign="top"></td>
                                        </tr>
                                    </table>
                                </form>
