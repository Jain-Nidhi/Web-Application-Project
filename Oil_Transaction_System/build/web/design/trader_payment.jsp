...
<html>
    <head>
        ...
        <title>OTS-Handle Payment</title>
        ...
        <script src="${pageContext.request.contextPath}/js/jquery.min.js" type="text/javascript"></script>
                ...
                $(document).ready(function(){
                        $.getJSON("../user_info", function(result){
                         ...
                         $.getJSON("../fetch_traderpaidpayments", function(result){
                            $.each(result, function(i, field){
                               $("#paymenthistory").append("<tr><td><h5 style=\"margin-left: 10pt;margin-bottom: 3pt;margin-top: 5pt;color: green\">PayId #"+field.paymentid.substring(0,8)+" / Client #"+field.clientid.substring(0,8)+"</h5><h5 style=\"margin-left: 10pt;margin-bottom: 3pt;margin-top: 5pt;color: slategrey\">Order #"+field.tid.substring(0,8)+" ,Paid = $"+field.amount+"</h5></td><td valign=\"bottom\"><form id=\"clear\" action=\"/Oil_Transaction_System/payment_oil\" ><input type=\"hidden\" name=\"payid\" value=\""+field.paymentid+"\" ><input name=\"opt6\" class=\"button\" type=\"submit\" value=\"Clear\"  style=\"margin-left: 10pt\"/></form></td></tr><tr><td colspan=\"2\"><hr align=\"left\" style=\"margin-left: 10pt;width: 95%\"></td></tr>");
                        });
                        });
                });
                ...
                function abc(){
                    $.getJSON("../month_info", function(result){
                          ...
                          $("#oilrate").append("@ $"+result.currpur+"/barrel");
                          else
                          $("#oilrate").append("@ $"+result.currsale+"/barrel");
                        });
                }
                </script>
    </head>
        ...
        <div id="header" style="width: 100%; height: 55pt">
            ...
            <table align="right" style="margin-right: 80pt">
                <tr>
                    <td style="width: 130pt">
                        <h3 style="color: steelblue;margin-bottom:  30pt">Handle Payments</h3>
                    </td>
                    <td>
            ...
            <div style="width: 100%; height: 442pt; background-color: lavender"> 
                        ...
                        <tr>
                            <td>
                                <ul>
                                    ...
                                    <li>
                                        <a id="pay" class="sel"  href="trader_payment.jsp">Client Payments</a>
                                    </li>
                                    <li>
               ...
               <br><br><br>
                                <ul>
                                    <li>
                                        <h3 style="margin-left: 5pt;margin-bottom: 1pt;margin-top: 2pt;color: steelblue">Client Payments</h3>
                                    </li>
                                </ul>
                    <br>
                    <br>
