                        ...
                        $.getJSON("../user_info", function(result){
                         ...
                         //   });
                          ...
                          document.getElementById("phone").value = result.phone;
                           ...
                           document.getElementById("cellphone").value = result.cellphone;
            ...
            <table align="right" style="margin-right: 80pt">
                <tr>
                    <td style="width: 100pt">
                        <h3 style="color: steelblue;margin-bottom:  30pt">Client Profile[Edit]</h3>
                    </td>
                    <td>
            ...
            <div style="width: 100%; height: 442pt; background-color: lavender"> 
                ...
                <div style="width: 85%; height: 440pt; background-color: white;margin-left: 80pt">
                    ...
                    <h3 style="margin-left: 35pt;margin-bottom: 1pt;margin-top: 2pt;color: steelblue">Profile</h3>
                                ...
                                <form action="/Oil_Transaction_System/profile" >
                                    <table align="left" cellspacing="20" style="margin-top: 10pt">
                                        <tr>
                                            <td valign="top">
                                                First Name
                                            </td>
                                            <td  valign="top" style="color: slategray">
                                                <input id="fname" type="text" name="fname" style=" color: darkgray" value="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top">
                                            ...
                                            <td valign="top" style="color: slategray">
                                                <input id="lname" type="text" name="lname" style=" color: darkgray" value="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top">
                                            ...
                                            <td  valign="top" style="color: slategray">
                                                <input id="street" type="text" name="street" style=" color: darkgray" value="">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" style="color: slategray">
                                                <input id="city" type="text" name="city" style=" color: darkgray" value="">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" style="color: slategray">
                                                <input id="state" type="text" name="state" style=" color: darkgray" value="">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" style="color: slategray">
                                                <input id="zip" type="text" name="zip" style=" color: darkgray" value="">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" style="color: slategray">
                                                <input id="phone" type="text" name="phone" style=" color: darkgray" value="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top">
                                            ...
                                            <td valign="top" style="color: slategray">
                                                <input id="cellphone" type="text" name="cellphone" style=" color: darkgray" value="">
                                            
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top"><input class="button" type="submit" value="Save"/></td>
                                            <td valign="top"></td>
                                        </tr>
                                    </table>
                                </form>
